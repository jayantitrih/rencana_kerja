...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_language_path	= 'public/grocery_crud/languages';
	protected $default_config_path		= 'public/grocery_crud/config';
	protected $default_public_path		= 'public/grocery_crud';
	...
	protected function _initialize_variables()
	{
		...
		$this->default_javascript_path				= $this->default_public_path.'/js';
		$this->default_css_path						= $this->default_public_path.'/css';
		$this->default_texteditor_path 				= $this->default_public_path.'/texteditor';
		$this->default_theme_path					= $this->default_public_path.'/themes';
	...
	public function set_field_upload($field_name, $upload_dir = '', $allowed_file_types = '')
	{
		$upload_dir = !empty($upload_dir) && substr($upload_dir,-1,1) == '/'
						...
						: $upload_dir;
		$upload_dir = !empty($upload_dir) ? $upload_dir : 'public/uploads/files';
